...
{   /**
    ...
    */
    class Modifiers
    {
         ...
         * @param array $dctElement - массив элемента инфоблока
         * @param array $arParams - массив параметров
         *      GALLERY - код свойства-галереи (или массив кодов), по которым будет произведена обработка, 
         *          в результате которой в массиве элемента появится ключ 'FILES',
         *          в котором будет массив с данными всех файлов из галереи
         *      MAIN - код, в который будет помещено главное фото элемента, которое будет определяться в следующем порядке:
         *          1) DETAIL_PICTURE
         *          2) PREVIEW_PICTURE
         *          3) первое фото из галереи (если указано в параметрах и если есть)
         *      пример: ['GALLERY'=>['PHOTOS'],'MAIN'=>'PICTURE']
         * @return array - массив элемента инфоблока с добавленными данными по файлам-картинкам
         */
